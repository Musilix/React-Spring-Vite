    ...
    <>
      ...
      <form className = "user-info" autoComplete = "off">
        <div className = "user-info-fields">
          <input name = "name" type = "text" placeholder = "Your Name"  value = {birthName} onChange = {(e) => updateBirthName(e)}></input>
          <input name = "age" type = "text" placeholder = "Your Age" value = {age} onChange = {(e) => updateAge(e)}></input>
          <input name = "gender" type = "text" placeholder = "Your Gender" value = {sex} onChange = {(e) => updateSex(e)}></input>
        </div>
